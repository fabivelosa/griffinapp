...
public class Event {
	...
	public Events getEvent(@PathParam("id") final int eventId) {
		final Events event = eventService.findById(eventId);
	...
	public Response getSampleJSONResponse() {
		final EventsUploadResponseDTO sample = new EventsUploadResponseDTO();
