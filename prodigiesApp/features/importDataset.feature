...
Feature: As the System Administrator, 
  ...
  Scenario Outline: Upload of Complete Base Dataset Without Consistency Check
    ...
    Examples: 
      ...
      | /resources/datasets/complete_dataset_zero_row.xlsx 	| Parsing Complete: Read 0 row. 		|	No new data saved	 |
      | /resources/datasets/complete_dataset_one_row.xlsx 	| Parsing Complete: Read 1 row. 		|	Saved 1 row			   |
      | /resources/datasets/complete_dataset.xlsx 					| Parsing Complete: Read 1000 rows. |	Saved 1000 rows 	 |					     |
      | /resources/datasets/empty_dataset.xlsx 							| Parsing Failed: The file is empty.| No new data saved  |               |
